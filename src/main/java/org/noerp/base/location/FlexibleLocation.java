 ...
 * under the License.
 *******************************************************************************/
package org.noerp.base.location;
...
public final class FlexibleLocation {
    ...
    static {
        ...
        resolverMap.put("noerphome", new NoERPHomeLocationResolver());
     ...
     * Supports NoERP specific location types like noerphome and component
