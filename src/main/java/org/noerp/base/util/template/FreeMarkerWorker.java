 ...
 * under the License.
 *******************************************************************************/
package org.noerp.base.util.template;
...
import org.noerp.base.util.UtilCodec;
...
public class FreeMarkerWorker {
    ...
    private static final BeansWrapper defaultNoerpWrapper = new BeansWrapperBuilder(version).build();
    private static final Configuration defaultNoerpConfig = makeConfiguration(defaultNoerpWrapper);

    public static BeansWrapper getDefaultNoerpWrapper() {
        return defaultNoerpWrapper;
    }
    ...
    public static Configuration makeConfiguration(BeansWrapper wrapper) {
        ...
        try {
            newConfig.setSharedVariable("EntityQuery", staticModels.get("org.noerp.entity.util.EntityQuery"));
        ...
        newConfig.setTemplateExceptionHandler(new FreeMarkerWorker.NoerpTemplateExceptionHandler());
        try {
    ...
    public static Environment renderTemplateFromString(String templateString, String templateLocation, Map<String, Object> context, Appendable outWriter) throws TemplateException, IOException {
        ...
        if (template == null) {
            ...
            template = new Template(templateLocation, templateReader, defaultNoerpConfig);
    ...
    /**
     * Returns a <code>Configuration</code> instance initialized to Noerp defaults. Client code should
     * call this method instead of creating its own <code>Configuration</code> instance. The instance
     * returned by this method includes the <code>component://</code> resolver and the Noerp custom
     * transformations.
     * 
     * @return A <code>Configuration</code> instance.
     */
    public static Configuration getDefaultNoerpConfig() {
        return defaultNoerpConfig;
    }
    ...
    public static Template getTemplate(String templateLocation) throws TemplateException, IOException {
        return getTemplate(templateLocation, cachedTemplates, defaultNoerpConfig);
    }
    ...
    */
    ...
    public static TemplateModel autoWrap(Object obj, Environment env) {
       ...
       try {
           templateModelObj = getDefaultNoerpWrapper().wrap(obj);
       } catch (TemplateModelException e) {
    ...
    /**
     * Noerp Template Source. This class is used by FlexibleTemplateLoader.
     */
    ...
    /**
     * Noerp Template Loader. This template loader uses the FlexibleLocation
    ...
    /**
     * Noerp specific TemplateExceptionHandler.  Sanitizes any error messages present in
     * the stack trace prior to printing to the output writer.
     */
    static class NoerpTemplateExceptionHandler implements TemplateExceptionHandler {
